...
export default {
  ...
  help: `Interactively add a new scheduled task. Prompts for name, instructions, repeat interval, and optional time window.
...
/schedule add`,
  ...
  execute: async ({ agent }: AgentCommandInputType<typeof inputSchema>): Promise<string> => {
    ...
    try {
      ...
      throw new CommandFailedError(`Invalid task configuration`, { cause: err });
    }
  },
